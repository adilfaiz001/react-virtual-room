...
if (typeof window.RTCPeerConnection !== 'undefined') {
    ...
    var RTCPeerConnection00 = window.mozRTCPeerConnection;
} else if (typeof webkitRTCPeerConnection !== 'undefined') {
    var RTCPeerConnection00 = window.webkitRTCPeerConnection;
}
...
export var RTCPeerConnection = function (options) {
    ...
    if(peer.addTrack === 'function') {
        ...
        peer.ontrack = function(event) {
            ...
            console.log('on:add:stream', remoteMediaStream);
        };
    }
    else {
        // attachStream = MediaStream;
...
export  var getUserMedia = function(options) {
